...
$ patch -p1 < /somewhere2/JGLUE/fine-tuning/patch/transformers-4.9.2_jglue-1.3.0.patch
$ pip install .
...
$ python /somewhere/transformers-4.9.2/examples/pytorch/text-classification/run_glue.py \
     ...
     --train_file ../datasets/marc_ja-v1.3/train-v1.3.json \
     --validation_file ../datasets/marc_ja-v1.3/valid-v1.3.json \
     --test_file ../datasets/marc_ja-v1.3/valid-v1.3.json \
...
```bash
     ..
     --train_file ../datasets/marc_ja-v1.3_jumanpp/train-v1.3.json \
     --validation_file ../datasets/marc_ja-v1.3_jumanpp/valid-v1.3.json \
     -test_file ../datasets/marc_ja-v1.3_jumanpp/valid-v1.3.json \
     ..  
```
...
$ python scripts/generate_results.py \
     ...
     --input-file ../datasets/marc_ja-v1.3/valid-v1.3.json \
...
$ python scripts/generate_results.py \
     ...
     --input-file ../datasets/jsts-v1.3/valid-v1.3.json \
...
$ python scripts/generate_results.py \
     ...
     --input-file ../datasets/jnli-v1.3/valid-v1.3.json \
     --task-type sentence-pair \
     --additional-column-name-string sentence_pair_id,yjcaptions_id > $OUTPUT_DIR/predict_eval_results.tsv
``` 
## QA: JSQuAD
...
$ python /somewhere/transformers-4.9.2/examples/legacy/question-answering/run_squad.py \
     ...
     --output_dir $OUTPUT_DIR \
     --train_file ../datasets/jsquad-v1.3/train-v1.3.json \
     --predict_file ../datasets/jsquad-v1.3/valid-v1.3.json \
     --save_steps 5000 \
     --warmup_ratio 0.1 \
...
$ python /somewhere/transformers-4.9.2/examples/pytorch/multiple-choice/run_swag.py \
     ...
     --num_train_epochs 4 \
     --output_dir $OUTPUT_DIR \
     --train_file ../datasets/jcommonsenseqa-v1.3/train-v1.3.json \
     --validation_file ../datasets/jcommonsenseqa-v1.3/valid-v1.3.json \
     --test_file ../datasets/jcommonsenseqa-v1.3/valid-v1.3.json \
     --use_fast_tokenizer False \
     --evaluation_strategy epoch \
     --warmup_ratio 0.1
```
...
$ python scripts/generate_results.py \
     ...
     --input-file ../datasets/jcommonsenseqa-v1.3/valid-v1.3.json \
     --task-type swag \
